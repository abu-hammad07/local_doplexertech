...
Route::get('shows/details/singe_episode/{id}/{episode_id}', 'ShowsController@single_episode_details');
Route::get('shows/details/{series_slug}/{id}', 'ShowsController@show_details');
Route::get('shows/single_episode/watch/{id}', 'ShowsController@watch_single_episode');
...
Route::get('auth/code','IndexController@subscribe');
Route::get('/auth/resend_pincode','IndexController@postResendPincode');
Route::post('auth/code','IndexController@postSubscribe');
...
Route::get('password/phonenumber', 'Auth\ForgotPasswordController@forget_password');
Route::post('password/phonenumber', 'Auth\ForgotPasswordController@forget_password_submit');
...
//proxy routes
Route::get('/proxy/convert_video_url', 'ProxyController@convertVideoUrl')->name('proxyVideo');
Route::get('/proxy', 'ProxyController@getVideoData')->name('chukVideo');
Route::get('/proxy/get_media_url', 'ProxyController@getMediaurl')->name('mediaUrl');
Route::get('/proxy/get_media_data', 'ProxyController@getMediaData')->name('mediaData');
