      ...
      <ul class="splide__list">
        ...
        <li class="splide__slide" video-id="{{$slider_data->id}}" slider-id="{{$index}}">
            ...
            <div class="video-show">
              <video style="object-fit: cover;" src="{{ $slider_data->file_url_state === 0 ? App\Slider::getMoviesInfo($slider_data->slider_post_id)->video_url : $slider_data->slider_video}}" class="d-none" width="100%" height="100%">
              </video>
