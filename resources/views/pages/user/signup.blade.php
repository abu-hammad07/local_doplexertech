      ...
      <div class="col-md-12">
        ...
        <div class="container login-part">
          ...
          <div class="col-12 col-lg-12 col-xl-12 mx-auto">
            ...
            <div class="form-group">
              <input type="text" class="form-control" onkeypress="return isNumber(event)" name="phone" id="phone" maxlength="11" value="{{old('phone')}}" placeholder="Phone Number" required>
            </div>
            <div class="form-group">
