        ...
        <div class="container login-part">
          ...
          <div class="col-12 col-lg-12 col-xl-12 mx-auto">
            ...
            <div class="form-group">
              <input type="text" onkeypress="return isNumber(event)" maxlength="11" name="phone" id="phone" value="{{old('phone')}}" class="form-control" placeholder="Phone Number" required>
            </div>
            <div class="form-group">
            ...
            @endif
              ...
              <div class="row mt-4">
              <div class="col">
              <div class="form-check custom-control custom-checkbox align-items-center d-flex justify-content-start">
                <input id="remember-me" name="remember" class="form-check-input mb-5" type="checkbox">
                <label class="custom-control-label text-nowrap" for="remember-me">{{trans('words.remember_me')}}</label>                
              </div>
              </div>
              <div class="text-3 text-center mb-3 text-nowrap align-items-center d-flex  justify-content-end"><a href="{{ URL::to('password/phonenumber') }}" class="btn-link" title="forgot password"> {{trans('words.forgot_password')}}?</a></div>
            </div>
            <button class="btn-submit btn-block my-4 mb-4" type="submit">{{trans('words.login_text')}}</button>
            {!! Form::close() !!}
            <p class="text-3 text-center mb-3 d-flex align-items-center justify-content-center text-nowrap">{{trans('words.dont_have_account')}} <a href="{{ url('signup') }}" class="btn-link" title="signup">{{trans('words.sign_up')}}</a></p>
