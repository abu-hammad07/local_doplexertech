      ...
      <div class="col-md-12">
        ...
        <div class="container login-part">
          ...
          <div class="col-12 col-lg-12 col-xl-12 mx-auto">
            ...
            {!! Form::open(array('url' => 'password/phonenumber',  'class'=>'','id'=>'forget_pass_form','role'=>'form','onsubmit'=>'return submitForm();')) !!}
            <div class="form-group">
              <input type="text" maxlength="11" class="form-control" onkeypress="return checkinput(event)" name="phone" id="phone" required placeholder="Phone Number">
            </div>            
            @if(getcong('recaptcha_on_forgot_pass'))
            <div class="form-group">
