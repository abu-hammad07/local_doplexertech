...
<div class="slider-area">
  <div class="container-fluid">
    <div class="row">
      <div class="splide">
    <div class="splide__track slider-container " id="video-slider">
      <ul class="splide__list">
        ...
        <li class="splide__slide" video-id="{{$slider_data->id}}" slider-id="{{$index}}">
            ...
            <div class="video-show">
              <video style="object-fit: cover;" class="d-none" width="100%" height="100%" src="{{ $slider_data->file_url_state === 0 ? App\Slider::getMoviesInfo($slider_data->slider_post_id)->video_url : $slider_data->slider_video}}">
              </video>
      ...
      <!-- <ol class="carousel-indicators d-flex align-items-center justify-content-center" style="z-index:11">
          @foreach($slider as $index => $slider_data)
            <li data-target="#video-slider" data-slide-to="{{$index}}" class="{{$index === 0 ? 'active' : ''}} mx-2"></li>
          @endforeach
      </ol> -->
    </div>
    </div>
