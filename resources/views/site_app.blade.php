...
<!-- Favicon -->
<link rel="icon" href="{{ URL::asset('/'.getcong('site_logo')) }}">
...
<link rel="stylesheet" href="{{ URL::asset('site_assets/css/customize.css') }}">
<link rel="stylesheet" href="{{ URL::asset('site_assets/css/custom_responsive.css') }}">
...
@if(!classActivePathSite('login') AND !classActivePathSite('signup') AND !classActivePathSite('password') AND !classActivePathSite('auth.code'))

    @include("_particles.header") 

@endif

    @include("_particles.leftbanner")
...
<script src="{{ URL::asset('site_assets/js/slider_customize.js') }}"></script> 
<script src="{{ URL::asset('site_assets/js/customize.js') }}"></script> 
