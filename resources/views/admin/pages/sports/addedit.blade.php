              ...
              <div class="card-box">
                ...
                <div class="row">
                 ...
                 {!! Form::open(array('url' => array('admin/sports/add_edit_video'),'class'=>'form-horizontal','name'=>'video_form','id'=>'video_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="form-group row {{(isset($video_info->video_access) AND $video_info->video_access=='Free') ? 'd-none' : '' }}" tag-role="set-freetime">
                    <label class="col-sm-3 col-form-label">Free Time</label>
                    <div class="col-sm-8">
                      <div class="input-group">
                      <input type="text" name="free_time" onkeypress="return inpute_check_number(event);" id="free_time" value="{{ isset($video_info->free_time) ? $video_info->free_time : old('free_time') }}" class="form-control" placeholder="seconds">
