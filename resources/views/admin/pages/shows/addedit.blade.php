               ...
               @if(!getcong('tmdb_api_key'))
                ...
                @endif  
                 ...
                 {!! Form::open(array('url' => array('admin/series/add_edit_series'),'class'=>'form-horizontal','name'=>'series_form','id'=>'series_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="form-group row {{(isset($series_info->series_access) AND $series_info->series_access=='Free') ? 'd-none' : '' }}" tag-role="set-freetime">
                    <label class="col-sm-3 col-form-label">Free Time</label>
                    <div class="col-sm-8">
                      <div class="input-group">
                      <input type="text" name="free_time" onkeypress="return inpute_check_number(event);" id="free_time" value="{{ isset($series_info->free_time) ? $series_info->free_time : old('free_time') }}" class="form-control" placeholder="seconds">
