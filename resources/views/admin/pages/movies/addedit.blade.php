              ...
              <div class="card-box">
                ...
                @endif
                 ...
                 <div class="row">
                  ...
                  <div class="form-group row {{(isset($movie->video_access) AND $movie->video_access=='Free') ? 'd-none' : '' }}" tag-role="set-freetime">
                    <label class="col-sm-3 col-form-label">Free Time</label>
                    <div class="col-sm-8">
                      <div class="input-group">
                      <input type="text" name="free_time" onkeypress="return inpute_check_number(event);" id="free_time" value="{{ isset($movie->free_time) ? $movie->free_time : old('free_time') }}" class="form-control" placeholder="seconds">
