<div class="topbar">
      <div class="topbar-left d-flex align-items-center justify-content-center"> 
        <a href="{{ URL::to('admin/dashboard') }}" style="height:65px; width: 65px;" class="logo">
          <span >
            @if(getcong('site_logo')) 
            <img src="{{ URL::asset('/'.getcong('site_logo')) }}" alt="Site Logo" width="100%" style="object-fit:cover" height="100%">
            @else
            <img src="{{ URL::asset('site_assets/images/logo.png') }}" alt="Site Logo" width="100%" style="object-fit:cover" height="100%">           
            @endif
          </span>
